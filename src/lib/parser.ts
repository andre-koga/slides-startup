 ...
 */
const parseMultilineElements = (lines : (string | SlideElement)[], lineNumber : number) : (string | SlideElement)[] => {
 ...
 */
const parseSingleLineElements = (slideLines : (string | SlideElement)[], lineNumber : number) : SlideElement[] => {
